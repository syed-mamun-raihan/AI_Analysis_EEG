function [success, net, svmStruct, svmCp, dataX, dataY] = testPCA(sample,raw,ch1,ch2,classA,classB)
%[success, net, svmStruct, svmCp, dataX, dataY] = testPCA(sample,ch1,ch2,classA,classB)
%------------------------------------
%   INPUT
%------------------------------------
...
MONTAGE1 = ch1;
MONTAGE2 = ch2;
msg_out = ['Testing PCA Model with Using NN, SVM, GLM(Linear-MLM), MR(Linear-LS)' ]
sampleStart = 1;
sampleLength = 1000;
