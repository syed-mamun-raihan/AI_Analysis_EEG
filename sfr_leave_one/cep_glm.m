...
vaso1 = cep(1,111:115);
nonvaso1=cep(1,271:275);
cd ../masse2
load validation4.mat
vaso2 = cep(6,1:5);
nonvaso2 = cep(6,46:50);
cd ../voth3
load validation9.mat
vaso3 = cep(5,1:5);
nonvaso3 = cep(5,76:80);
cd ../liz4/
load validation6.mat
vaso4=cep(2,1:5);
nonvaso4=cep(2,26:30);
cd ../coma8
...
if class < 0.5
    ...
    tot = tot/2;
disp('-----------------')    
disp('Test result with Sum-Of-Cepstrum using logistic regression')
disp('-----------------')
